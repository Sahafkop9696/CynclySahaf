...
using BatchesAssesment8.Models;

namespace BatchesAssesment8.Controllers
{
    ...
    public class BatchesController : ControllerBase
    {
        ...
        //public BatchesController(BatchManagementContext context)
        //{
        //    _context = context;
        //}

        BatchManagementContext _context = new BatchManagementContext();
        // GET: api/Batches
        [HttpGet]
